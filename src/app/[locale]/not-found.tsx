        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4">
            <div className="mx-auto max-w-[530px] text-center">
              ...
              <h3 className="mb-4 font-bold text-3xl text-black sm:text-4xl dark:text-white">
                Sorry, the page can’t be found
              </h3>
              <p className="mb-10 font-medium text-base text-body-color leading-relaxed sm:text-lg sm:leading-relaxed">
                The page you were looking for appears to have been moved,
                deleted or does not exist.
              </p>
              <Link
                href="/"
                className="rounded-md bg-primary px-8 py-3 font-bold text-base text-white shadow-signUp duration-300 hover:bg-white hover:text-primary md:px-9 lg:px-8 xl:px-9"
              >
                Back to Homepage
              </Link>
            </div>
