...
const Header = () => {
  ...
  return (
    <header className="header fixed inset-s-0 top-0 z-9999 flex w-full items-center bg-white/80 shadow-sticky backdrop-blur-sm dark:bg-gray-dark/80 dark:shadow-sticky-dark">
      <div className="container">
        <div className="relative -mx-4 flex items-center justify-between">
          <div className="shrink-0 px-4 xl:me-12">
            <Link href="/" className="header-logo block py-5">
              <Image
                src="/images/logo/logo-2.svg"
                alt="logo"
                width={160}
                height={36}
                className="h-6 w-auto md:h-9 dark:hidden"
              />
              <Image
                ...
                width={160}
                height={36}
                className="hidden h-6 w-auto md:h-9 dark:block"
              />
            </Link>
          </div>
          <div className="flex w-full items-center justify-between px-4">
            <div>
              <nav
                ref={navbarRef}
                id="navbarCollapse"
                className={`navbar absolute inset-e-0 z-30 w-62.5 rounded-lg border border-stroke bg-white px-6 py-4 shadow-two transition-[top,opacity,visibility] duration-200 lg:visible lg:static lg:w-auto lg:border-none lg:bg-transparent! lg:p-0 lg:opacity-100 lg:shadow-none dark:border-stroke-dark dark:bg-dark ${
                  navbarOpen
            ...
            <div className="flex items-center justify-end gap-2">
              <a
                ...
                className="btn btn-primary me-1 hidden whitespace-nowrap px-4 py-2 md:inline-flex"
              >
              ...
              <button
                ...
                className="rounded-lg px-3 py-1.5 focus-visible:outline-2 focus-visible:outline-primary focus-visible:outline-offset-2 lg:hidden"
              >
                <span
